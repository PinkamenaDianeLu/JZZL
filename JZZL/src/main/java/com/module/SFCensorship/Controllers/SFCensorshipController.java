...
public class SFCensorshipController extends BaseFactory {
    ...
    public String createNewSFCensorship(String params) {
        ...
        try {
            ...
            newSFC.setArchivetype(pJsonObj.getInteger("archivetype"));
            newSFC.setArchivename(pJsonObj.getString("archivename"));
            sFCensorshipService.insertSelective(newSFC);

            //得到新建的送检记录id  用此id复制新建RECORDS
            //这里即使没有recordsId也可以，即没有选择records
            //TODO MrLu 2020/10/4   recordsId插入
//            String recordsId= Optional.ofNullable(pJsonObj.getString("recordsId")).orElse("");
//            String [] recordsIds=  recordsId.split(",");
