...
public class FunArchiveCover { private Integer id;
    ...
    public void setSuspectsid(String suspectsid) {
        this.suspectsid = suspectsid == null ? null : suspectsid.trim();
    }

    public String getSuspectsxm() {
        return suspectsxm;
    }
