...
public class FunArchiveXzcoverDTO {
    private Integer id;
    ...
    public void setQzcode(String qzcode) {
        this.qzcode = qzcode == null ? null : qzcode.trim();
    }
    ...
    public void setLbcode(String lbcode) {
        this.lbcode = lbcode == null ? null : lbcode.trim();
    }
    ...
    public void setMlcode(String mlcode) {
        this.mlcode = mlcode == null ? null : mlcode.trim();
    }
    ...
    public void setAjcode(String ajcode) {
        this.ajcode = ajcode == null ? null : ajcode.trim();
    }
