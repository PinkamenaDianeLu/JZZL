...
public interface FunArchiveSFCDTOMapper {
     ...
     * @createTime  2022/2/16 16:12
     * @return    |  
      */
    List<FunArchiveSFCDTO> selectSendErrorArchive(Integer caseinfoid);
     ...
     * @author MrLu
     * @param ajbh
     * @createTime  2022/3/16 15:57
     * @return    |
      */
    Integer selectCountSended(String ajbh);
}