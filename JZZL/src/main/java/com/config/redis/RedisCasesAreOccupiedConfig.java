...
public class RedisCasesAreOccupiedConfig {

    @Value("${spring.redis.casesAreOccupied}")
     ...
     */
    @Bean
    @Qualifier("createCasesAreOccupiedLettuceConnectionFactory")
    LettuceConnectionFactory createCasesAreOccupiedLettuceConnectionFactory(GenericObjectPoolConfig genericObjectPoolConfig) {
